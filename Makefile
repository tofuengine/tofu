...
INCLUDES+=$(wildcard external/dr_libs/*.h external/glad/*.h external/GLFW/*.h external/lua/*.h external/miniaudio/*.h external/spleen/*.h external/stb/*.h external/xmp-lite/*.h external/xmp-lite/hio/*.h)
OBJECTS:=$(SOURCES:%.c=%.o)
