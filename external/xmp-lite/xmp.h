...
LIBXMP_EXPORT int         xmp_load_module_from_callbacks(xmp_context opaque, size_t (*read)(void *, void *, size_t), int (*seek)(void *, long, int), long (*tell)(void *), int (*eof)(void *), void *userdata);
