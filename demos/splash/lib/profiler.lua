...
function module.report(filename)
  ...
  fileWriter = fileWriter .. totalTimeOutput
  if printFun ~= nil then
    printFun(totalTimeOutput)
  end
  fileWriter = fileWriter .. divider
  fileWriter = fileWriter .. formatHeader
  fileWriter = fileWriter .. divider
  ...
  fileWriter = fileWriter .. divider
  File.store(filename, fileWriter)
  if printFun ~= nil then
